...
//        int intA = 10;
//        long longA = 10;
//        // long은 명시적으로 L을 붙여 long타입임을 명시하시도함
//        long longB = 20L;
//
//        // 실수 : float, double(기본형)
//        float f1 = 1.123f;
...
//        // 소수점이 누적됐을때 우의미한 오차발생
//        double total = 0;
//        for(int i=0; i<1000; i++){
//            total = total + 0.1;
//        }
//        System.out.println(total);
//    //  소수점 오차 해결바업 : 정수로 변환 후 연산하여 추후 나눗셈으로 해결
//        double total2 = 0;
//        for(int i=0; i<1000; i++){
...
//        int i2 = (int)d2;
//
////        정수/정수의 경우 소수점 절사문제 발생
//        int a = -1;
//        int b = 4;
//        double d = a/b;
//        System.out.println(d);
////        두 정수중에 한 정수만이라도 double형변환시 소수점 절사문제해결
//        double c = (double)a/b;
